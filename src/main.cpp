...
uint256 hashGenesisBlock("0xaba6aa1ccba3361977a914217c1f84922c631a4ecd02d6875054d465335bd045");
...
const string strMessageMagic = "FixCoin Signed Message:\n";
...

{
    ...
    if (nHeight < 1000000)  
        {nSubsidy = ((50 * COIN) / (.05 * sqrt(nHeight)) );}
...
// Thanks: Balthazar for suggesting the following fix ---ACTUALLY BALTHAZAR'S BEST WORK IS THE NOVACOIN CODE NOT THIS TWEAK --- IMO
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal fixcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FixCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xaba6aa1ccba3361977a914217c1f84922c631a4ecd02d6875054d465335bd045");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "imagine a coin where the harder you hit it the less you get from it, an incentive not to mine";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1398548614; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 289466;

        if (fTestNet)
        {
            block.nTime    = 1398548614;
            block.nNonce   = 289466;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x52dde70d67c9e69bb6f85330382cd7568a81a898127615f7e53084cdc25ce16a"));
